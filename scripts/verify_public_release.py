...
def _checks(*, full: bool) -> list[Check]:
    ...
    checks = [
        ...
        Check(
            "problem_family_handoff_fixture",
            [py, "-m", "unittest", "tests.test_problem_family_handoff_fixture", "-v"],
            env=_env("src:."),
        ),
        Check(
            "handoff_fixture_index",
            [py, "-m", "unittest", "tests.test_handoff_fixture_index", "-v"],
            env=_env("src:."),
        ),
        Check(
